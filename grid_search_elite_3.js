...
async function start() {
  ...
  const histAvgSteps = [0.60, 0.65, 0.70];
  const histSingleSteps = [0.0, 0.50, 0.60];
  const formAvgSteps = [0.60, 0.65, 0.70];
  const formSingleSteps = [0.0, 0.50, 0.60];
  const edgeSteps = [0.0, 0.05, 0.10];
  const probSteps = [0.55, 0.60, 0.65];
  ...
  console.log("\n--- TOP COMBINAZIONI (ALMENO 50 BETS) ---");
