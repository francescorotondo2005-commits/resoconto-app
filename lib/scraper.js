...
async function scrapeSportium(page, league, homeTeam, awayTeam) {
  ...
  try {
    const LEAGUE_MAP = {
      ...
      'ChampionsLeague': { slug: 'uefa-champions-league', nome: 'Champions League' },
      'EuropaLeague': { slug: 'uefa-europa-league', nome: 'Europa League' },
      'ConferenceLeague': { slug: 'uefa-europa-conference-league', nome: 'Conference League' },
      'CoppaItalia': { slug: 'italia-coppa-italia', nome: 'Coppa Italia' },
      'FACup': { slug: 'inghilterra-fa-cup', nome: 'FA Cup' },
      'CopaDelRey': { slug: 'spagna-copa-del-rey', nome: 'Copa del Rey' },
      'CoupeDeFrance': { slug: 'francia-coppa-di-francia', nome: 'Coppa di Francia' },
      'DFBPokal': { slug: 'germania-dfb-pokal', nome: 'DFB Pokal' },
      'EFLCup': { slug: 'inghilterra-efl-cup', nome: 'EFL Cup' },
    };
...
async function scrapeSportbet(page, league, homeTeam, awayTeam) {
  ...
  try {
    ...
    const leagueSlugs = { 
        ...
        CoupeDeFrance: 'coppa-di-francia',
        DFBPokal: 'dfb-pokal',
        EFLCup: 'efl-cup'
    };
