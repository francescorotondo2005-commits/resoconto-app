...
export function getAllMarkets() {
  ...
  // Tiri Ospite classici .5 da 6.5 a 18.5 (max 18 produce fino a 18.5)
  markets.push(...generateOverUnder('tiri', 'TIRI OSPITE', 6, 18, 1, 'ospite'));
  // E aggiungiamo manualmente l'intero (18 spaccato) richiesto
  markets.push({ name: 'OVER 18 TIRI OSPITE', type: 'over_under', direction: 'over', stat: 'tiri', scope: 'ospite', line: 18 });
  markets.push({ name: 'UNDER 18 TIRI OSPITE', type: 'over_under', direction: 'under', stat: 'tiri', scope: 'ospite', line: 18 });
