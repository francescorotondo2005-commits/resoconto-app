...
export function getAllMarkets() {
  ...
  // === TIP === (1X2 -> Totali -> Casa -> Ospite)
  markets.push(...generate1X2('tip', 'TIP'));
  markets.push(...generateOverUnder('tip', 'TIP TOTALI', 5, 10, 1, 'totale'));
  markets.push(...generateOverUnder('tip', 'TIP CASA', 0, 6, 1, 'casa'));
  markets.push(...generateOverUnder('tip', 'TIP OSPITE', 1, 5, 1, 'ospite'));
...
export function generateCustomMarket(stat, type, scope, direction, line, esito) {
  const labelMap = {
    gol: 'GOL', tiri: 'TIRI', tip: 'TIP', falli: 'FALLI',
...
export const MARKET_CATEGORIES = [
  'Gol', 'Tiri', 'TIP', 'Falli', 'Corner', 'Cartellini', 'Parate'
];
